/**
  ******************************************************************************
  * @file    STM8S207K6_Ex01\inc\stm8_tsl_conf.h
  * @author  MCD Application Team
  * @version V2.5.0
  * @date    14-October-2013
  * @brief   This file is a template for the RC acquisition and must be adapted to your requirements.
  ******************************************************************************
  * @attention
  *
...
#define TIMACQ           (TIM5)
#define TIMACQ_CNTR_ADD  (TIM5_BaseAddress+12)
...
// of the TIMACQ timer described above (TIM6 for example).
//
...
#define SCKEY_P1_A  (GPIO_PIN_1)  /**< Single channel key Port 1: 1st key mask */ 
#define SCKEY_P1_B  (GPIO_PIN_0)  /**< Single channel key Port 1: 2nd key mask */ 
...
#define SCKEY_P2_KEY_COUNT  (4)  /**< Single channel key Port 2: Number of keys used (value from 0 to 8) */

#define SCKEY_P2_PORT_ADDR  (GPIOC_BaseAddress)  /**< Single channel key Port 2: GPIO base address */

#define SCKEY_P2_A  (GPIO_PIN_1)  /**< Single channel key Port 2: 1st key mask */
#define SCKEY_P2_B  (GPIO_PIN_2)  /**< Single channel key Port 2: 2nd key mask */
#define SCKEY_P2_C  (GPIO_PIN_6)  /**< Single channel key Port 2: 3rd key mask */
#define SCKEY_P2_D  (GPIO_PIN_7)  /**< Single channel key Port 2: 4th key mask */
...
#define GPIOA_ELECTRODES_MASK  (0x00)                           
#define GPIOB_ELECTRODES_MASK  (GPIO_PIN_0 | GPIO_PIN_1)        
#define GPIOC_ELECTRODES_MASK  (GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_6 | GPIO_PIN_7)
#define GPIOD_ELECTRODES_MASK  (0x00)                           
#define GPIOE_ELECTRODES_MASK  (0x00)                           
#define GPIOF_ELECTRODES_MASK  (0x00)                           
#define GPIOG_ELECTRODES_MASK  (0x00)                           
#define GPIOH_ELECTRODES_MASK  (0x00)                           
#define GPIOI_ELECTRODES_MASK  (0x00)                           
...
#define MAX_MEAS_COEFF             (0x0126)  /**< Max measure guardband (MSB=integer part, LSB=decimal part) */
#define MIN_MEAS_COEFF             (0x00D9)  /**< Min measure guardband (MSB=integer part, LSB=decimal part) */

// Thresholds
#define SCKEY_DETECTTHRESHOLD_DEFAULT          (16)  /**< Single channel key detection threshold (value from 1 to 127) */
#define SCKEY_ENDDETECTTHRESHOLD_DEFAULT        (12)  /**< Single channel key end detection threshold (value from 1 to 127) */
...
// Integrators
#define DETECTION_INTEGRATOR_DEFAULT       (5)  /**< Detection Integrator = Debounce Filter (value from 0 to 255) */
#define END_DETECTION_INTEGRATOR_DEFAULT   (5)  /**< End detection Integrator = Debounce Filter (from 0 to 255) */
